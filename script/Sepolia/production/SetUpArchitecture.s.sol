    ...
    function run() external {
        ...
        */
        ...
        console.log("SwapWithUniswapAdaptor deployed at:", swapWithUniswapAdaptor);
               ...
               console.log("Deploying UniswapV3PositionTracker...");
               address tracker = deployContract("UniswapV3PositionTracker", creationCode, constructorArgs, 0);
               console.log("UniswapV3PositionTracker deployed at:", tracker);

               creationCode = type(UniswapV3Adaptor).creationCode;
               constructorArgs = abi.encode(uniswapV3PositionManager, tracker);
               console.log("Deploying UniswapV3Adaptor...");
               uniswapV3Adaptor = deployContract("UniswapV3Adaptor", creationCode, constructorArgs, 0);
               console.log("UniswapV3Adaptor deployed at:", uniswapV3Adaptor);
               ...
               console.log("Deploying AaveV3DebtTokenAdaptor...");
               aaveV3DebtTokenAdaptor = deployContract("AaveV3DebtTokenAdaptor", creationCode, constructorArgs, 0);
               console.log("AaveV3DebtTokenAdaptor deployed at:", aaveV3DebtTokenAdaptor);

               // Deploy ERC4626 Adaptor.
               creationCode = type(ERC4626Adaptor).creationCode;
               constructorArgs = hex"";
               console.log("Deploying ERC4626Adaptor...");
               erc4626Adaptor = deployContract("ERC4626Adaptor", creationCode, constructorArgs, 0);
               console.log("ERC4626Adaptor deployed at:", erc4626Adaptor);

               // Deploy 1Inch Adaptor.
               creationCode = type(OneInchAdaptor).creationCode;
               constructorArgs = abi.encode(oneInchTarget);
               console.log("Deploying OneInchAdaptor...");
               oneInchAdaptor = deployContract("OneInchAdaptor", creationCode, constructorArgs, 0);
               console.log("OneInchAdaptor deployed at:", oneInchAdaptor);

               // Deploy 0x Adaptor.
               creationCode = type(ZeroXAdaptor).creationCode;
               constructorArgs = abi.encode(zeroXTarget);
               console.log("Deploying ZeroXAdaptor...");
               zeroXAdaptor = deployContract("ZeroXAdaptor", creationCode, constructorArgs, 0);
               console.log("ZeroXAdaptor deployed at:", zeroXAdaptor);
/* AK TESTING COMMENTED
